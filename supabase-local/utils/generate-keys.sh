...
# Detect sed behavior for in-place editing
# macOS (BSD) requires a space/argument for -i, GNU does not (or expects attached)
# We will use -i.old backup extension for portability
