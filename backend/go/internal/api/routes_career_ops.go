...
func (s *Server) routesCareerOps(r chi.Router) {
	r.Group(func(r chi.Router) {
		...
		r.Post("/api/career-ops/evaluate", s.handleCareerOpsEvaluate)
		r.Post("/api/v1/career-ops/scan", s.handleCareerOpsScan)
		r.Post("/api/career-ops/scan", s.handleCareerOpsScan)
		r.Get("/api/v1/career-ops/patterns", s.handleCareerOpsGetPatterns)
		r.Get("/api/career-ops/patterns", s.handleCareerOpsGetPatterns)
		...
		r.Post("/api/career-ops/portals", s.handleCareerOpsSavePortal)
		r.Patch("/api/v1/career-ops/portals/{portal_id}", s.handleCareerOpsUpdatePortal)
		r.Patch("/api/career-ops/portals/{portal_id}", s.handleCareerOpsUpdatePortal)
		r.Delete("/api/v1/career-ops/portals/{portal_id}", s.handleCareerOpsDeletePortal)
		r.Delete("/api/career-ops/portals/{portal_id}", s.handleCareerOpsDeletePortal)

		r.Get("/api/v1/career-ops/story-bank", s.handleCareerOpsGetStoryBank)
		r.Get("/api/career-ops/story-bank", s.handleCareerOpsGetStoryBank)
		r.Post("/api/v1/career-ops/story-bank", s.handleCareerOpsSaveStoryBank)
		r.Post("/api/career-ops/story-bank", s.handleCareerOpsSaveStoryBank)
		r.Delete("/api/v1/career-ops/story-bank/{index}", s.handleCareerOpsDeleteStory)
		r.Delete("/api/career-ops/story-bank/{index}", s.handleCareerOpsDeleteStory)

		r.Get("/api/v1/career-ops/stats", s.handleCareerOpsGetStats)
		r.Get("/api/career-ops/stats", s.handleCareerOpsGetStats)
	})
}
...
func (s *Server) handleCareerOpsUpdatePortal(w http.ResponseWriter, r *http.Request) {
	portalIDStr := chi.URLParam(r, "portal_id")
	portalID, err := strconv.Atoi(portalIDStr)
	if err != nil {
		s.respondError(w, http.StatusBadRequest, "Invalid portal ID")
...
func (s *Server) handleCareerOpsDeleteStory(w http.ResponseWriter, r *http.Request) {
	indexStr := chi.URLParam(r, "index")
	index, err := strconv.Atoi(indexStr)
	if err != nil {
		s.respondError(w, http.StatusBadRequest, "Invalid story index")
		return
	}
	headers := s.getXUserHeaders(r)
...
func (s *Server) handleCareerOpsGetStats(w http.ResponseWriter, r *http.Request) {
	headers := s.getXUserHeaders(r)
