...
var get_profile_default = defineTool({
  ...
  handler: async (_input, ctx) => {
    ...
    const { data, error } = await sb(ctx).from("profiles").select("id, full_name, headline, summary, skills, desired_roles, locations, experience_years, open_to_remote").eq("id", ctx.getUserId()).maybeSingle();
