...
export const DESKTOP_DOWNLOADS: DesktopDownload[] = [
  ...
  { id: "windows", platform: "Windows", title: "Windows installer", description: "The guided Windows installer with Start menu and desktop shortcuts.", filename: "Job Tayari Desktop-0.1.0-x64.nsis.exe", architecture: "x64", requirements: "Windows 10 or newer" },
  { id: "linux", platform: "Linux", title: "Linux AppImage", description: "A portable Linux package that runs without a system installation step.", filename: "Job Tayari Desktop-0.1.0-x86_64.AppImage", architecture: "x86_64", requirements: "64-bit Linux with FUSE support" },
];
