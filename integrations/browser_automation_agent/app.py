...
Type a natural language instruction (e.g. "Find the latest news about AI agents")
and the agent will autonomously navigate the web to complete it.
"""
...
DESCRIPTION = (
    ...
    f"`browser-use` + LangChain (`{ORQ_MODEL}`)."
)
